...
public class DBHelper {
    private String DBurl = "jdbc:mysql://127.0.0.1/test23?serverTimezone=UTC&useSSL=false";
    private String JdbcName = "com.mysql.cj.jdbc.Driver";
    private String UserName = "root";
    private String PassWord = "123456";
    private String sql = "select * from testuser";
    ...
    public DBHelper(String DBurl, String JdbcName, String UserName, String PassWord, String sql) {
        ...
        try {
            ...
            System.out.println("数据库登录失败，数据库为：" + DBurl + "，用户名为：" + UserName + "，密码为：" + PassWord);
            System.out.println("数据路登录失败原因为：" +e2.getMessage());
            e2.printStackTrace();
        }
